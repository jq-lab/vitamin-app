...
struct EveningReviewSheet: View {
    ...
    private var header: some View {
        HStack {
            ...
            Button("关闭", action: onClose)
                ...
                .accessibilityIdentifier("vitora.review.close")
        }
    }
    ...
    private var reviewCard: some View {
        ...
        .padding(18)
        .background(GlassSurface(cornerRadius: 26, opacity: 0.44))
    }
    ...
    private var savedState: some View {
        ...
        .padding(18)
        .background(GlassSurface(cornerRadius: 24, opacity: 0.46))
