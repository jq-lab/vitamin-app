...
| 区域 | Onboarding |
| 优先级 | P0 Swift MVP |
| 产品行为 | 只收集 Vitora 初始理解需要的称呼、周期上下文、关注方向和 HealthKit 选择。 |
| 用户价值 | Vitora 能个性化第一天，但 onboarding 不像表单墙。 |
| 输入 | 称呼、周期日期/不确定、周期长度/不确定、关注方向、HealthKit 授权选择。 |
...
| 输出 | 月历/周历、今天、阶段色块、预测窗口、选中日期详情、Vitora 洞察。 |
| 状态 | todaySelected、dateSelected、predicted、recorded、lowConfidence。 |
| 关联事实 | F-P0-TODAY-002 |
| 关联流程 | UF-002, UF-009 |
| 关联 IA | IA-012 |
| 验收标准 | 从 Today 进入；能返回 Today；不把 Cycle 首页变成日历。 |
| 不在范围 | 高级周期分析、医疗预测。 |
